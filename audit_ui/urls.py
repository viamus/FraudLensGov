...
urlpatterns = [
    ...
    path("pipeline/qualidade", views.quality_page, name="quality"),
    path("investigacao", views.investigation_page, name="investigation"),
    path("investigacao/vizinhos", views.neighbors_page, name="neighbors"),
    ...
    path("normalizacao/clusters", views.clusters_page, name="clusters"),
    path("operacao", views.operation_page, name="operation"),
    path("operacao/ingestoes", views.ingestion_page, name="ingestion"),
