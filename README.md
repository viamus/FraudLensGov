...
- Material 3 inspired corporate audit shell with collapsible navigation, compact guided context, glossary terms, paginated/sortable table-first views, filters, CSV export, and alert detail pages.
...
Design system notes live in [docs/DESIGN_SYSTEM.md](docs/DESIGN_SYSTEM.md).
