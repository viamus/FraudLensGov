...
- Material 3 inspired corporate audit shell with collapsible navigation, guided page context, glossary terms, paginated/sortable table-first views, filters, CSV export, and alert detail pages.
